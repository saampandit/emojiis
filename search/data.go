...
var emojis = []Emoji{
	{Label: "grinning face", Tags: []string{"face", "grin"}, Emoji: "😀"},
	{
		...
		Tags:  []string{"face", "mouth", "open", "smile"},
		Emoji: "😃",
	},
	{
		Label:    "grinning face with smiling eyes",
		Tags:     []string{"eye", "face", "mouth", "open", "smile"},
		Emoji:    "😄",
		Emoticon: ":D",
	},
	{
		Label: "beaming face with smiling eyes",
		Tags:  []string{"eye", "face", "grin", "smile"},
		Emoji: "😁",
	},
	{
		Label:    "grinning squinting face",
		Tags:     []string{"face", "laugh", "mouth", "satisfied", "smile"},
		Emoji:    "😆",
		Emoticon: "xD",
	},
	{
		Label: "grinning face with sweat",
		Tags:  []string{"cold", "face", "open", "smile", "sweat"},
		Emoji: "😅",
	},
	{
		Label:    "rolling on the floor laughing",
		Tags:     []string{"face", "floor", "laugh", "rofl", "rolling", "rotfl"},
		Emoji:    "🤣",
		Emoticon: ":'D",
	},
	{
		Label:    "face with tears of joy",
		Tags:     []string{"face", "joy", "laugh", "tear"},
		Emoji:    "😂",
		Emoticon: ":')",
	},
	...
	{
		Label: "railway car",
		Tags:  []string{"car", "electric", "railway", "train", "tram", "trolleybus"},
		Emoji: "🚃",
	},
